...
<div class="box">
  ...
  <div class="box-body">
    ...
    @if(!empty(setting()->logo))
      <img src="{{ Storage::url(setting()->logo) }}" style="height: 100px;width: 100px;" />
    @endif
    <div class="form-group">
    ...
    @endif
    <div class="form-group">
      {!! Form::label('description',trans('admin.website_description')) !!}
      {!! Form::textarea('description',setting()->description,['class'=>'form-control']) !!}
    </div>
    <div class="form-group">
      {!! Form::label('keywords',trans('admin.website_keywords')) !!}
    ...
    <div class="form-group">
     ...
     <div class="form-group">
      {!! Form::label('status',trans('admin.website_status')) !!}
