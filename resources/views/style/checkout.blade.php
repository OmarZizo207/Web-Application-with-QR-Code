@extends('style.index')
@push('css')
    <link href="https://fonts.googleapis.com/css?family=Playfair+Display|Quicksand:400,700|Open+Sans|PT+Mono">
    <link href="{{ url('design/style') }}/css/checkout.css" rel="stylesheet">
@endpush
@push('js')
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <script src="https://stripe.github.io/jquery.payment/lib/jquery.payment.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js"></script>
    <script src="{{ url('design/style') }}/js/checkout.js"></script>
@endpush
@section('content')

    <div style="margin-top: 200px;" class='subject'>DailyUI #002 </br><strong>Credit Card Checkout</strong></div>

    <div style="margin-top: 200px;" class='checkout'>
        <div class='order'>
            <h2>Checkout</h2>
            <h5>Order #0101</h5>
            <ul class='order-list'>
            ...
            <h5> {{ trans('user.vat') }} </h5>
            <h4> {{ $total_price * 0.14 }} L.E</h4>

            <h5 class='total'>{{ trans('user.total_price') }}:</h5>
            <h1>
                 <?php
                    echo $total_price + ($total_price * 0.14);
                } else {
                    echo 0;
                }
                 ?>  L.E
