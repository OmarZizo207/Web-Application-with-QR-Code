...
class TableDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', 'admin.table.btn.edit')
            ->addColumn('checkbox', 'admin.table.btn.checkbox')
            ->addColumn('delete', 'admin.table.btn.delete')
            ->rawColumns([
                'edit',
                'checkbox',
                'delete',
    ...
    {
        return Table::query()->with('restaurant_id')->select('tables.*');
        //$model->newQuery();
    }
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        'dom'       => 'Blftrip',
                        'lengthcategory'=> [[10,25,50,100],[10,25,50,trans('admin.all_record')]],
                        'buttons'   => [
                            [
